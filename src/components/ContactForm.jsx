    ...
    <div class="container px-6 py-12 my-24 mx-auto grid md:grid-cols-2 items-start gap-16 bg-blue-500 rounded-xl">
      <div>
        ...
        <p class="text-md mt-4">
          Have some big idea to develop and need help? Then reach out
          we'd love to hear about your project and provide help.
        </p>

        <div class="mt-12">
          <h2 class="text-black text-base font-bold">Email</h2>
          <ul class="mt-4">
        ...
        <div class="mt-12">
          <h2 class="text-black text-base font-bold">Socials</h2>
