            ...
            <div className="grid items-center gap-8 lg:grid-cols-2">
              <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                ...
                <p className="mb-8 max-w-xl text-gray-400 lg:text-xl">
                  Our explainable and reliable AI solutions empower your
                  business to adapt and thrive. By enhancing transparency and
                  building trust, we ensure that your AI systems not only
                  deliver results but also provide clear insights into their
